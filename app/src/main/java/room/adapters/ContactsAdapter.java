...
public class ContactsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ContactsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
       ...
       /* private TextView contactName;
        ...
        public ContactsViewHolder(ContactsListItemBinding contactsListItemBinding) {
    ...
    public ContactsAdapter(Context context, List<ContactModel> contactModelList, RecyclerViewOnClickListener recyclerViewOnClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     ...
     /*   View v = LayoutInflater.from(parent.getContext())
        ...
        ContactsListItemBinding contactsListItemBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.contacts_list_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ContactsViewHolder) {
            ...
            ((ContactsViewHolder) holder).contactsListItemBinding.setContactModel(contactModel);
